...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("/Users/roger/own/dubbo-demo/guns/guns-film/src/main/java");//这里写你自己的java目录
        ...
        strategy.setInclude(new String[]{"banner","cat_dict","film","film_info","source_dict","year_dict","actor"});
